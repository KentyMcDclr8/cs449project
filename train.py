## Now, your focus should be to train the agent from the scratch without using any pretrained parameters in previous houses!
import torch
...
n_iters = 5000 if feedback_method == 'teacher' else 30000
...
def train(train_env, encoder, decoder, n_iters, log_every=100, val_envs={}):
    ...
    agent.load(encoder_path='tasks/R2R/snapshots/RxR_Model/All_houses_30000_Itr/seq2seq_sample_imagenet_train_enc_iter_30000',
               decoder_path='tasks/R2R/snapshots/RxR_Model/All_houses_30000_Itr/seq2seq_sample_imagenet_train_dec_iter_30000')
