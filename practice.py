import random
from sentences import perform_sentence_segmentation
...
## You may wanna change the location of these files! Right?
...
## We shall begin by defining our agent!
...
class Seq2SeqAgent(BaseAgent):
    ...
    def _feature_variable(self, obs):
        ...
        return Variable(torch.from_numpy(features), requires_grad=False)
    ...
    def _teacher_action(self, obs, ended):
        ...
        return Variable(a, requires_grad=False)
    ...
    def rollout(self):
        ...
        for ob in obs:
            ob['instruction']=perform_sentence_segmentation(ob['instruction'])
            print(ob['instruction'])
...
# Right here, I'll be doing some experimentation!
...
val_env = R2RBatch(features, batch_size=batch_size, splits=['val_unseen'], tokenizer=tok)
agent = Seq2SeqAgent(val_env, "", encoder, decoder, max_episode_len)
agent.load(encoder_path='tasks/R2R/snapshots/RxR_Model/seq2seq_sample_imagenet_train_enc_iter_20000',
               decoder_path='tasks/R2R/snapshots/RxR_Model/seq2seq_sample_imagenet_train_dec_iter_20000')
agent.rollout()
