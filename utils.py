...
def load_datasets(splits):
    ...
    for split in splits:
        ...
        # Change this to RxR_data/My_LandmarkRxR_ for training!
        with open('tasks/R2R/RxR_data/My_LandmarkRxR_%s.json' % split) as f:
            data += json.load(f)
    return data
...
## This write vocab function not behaving nicely!
